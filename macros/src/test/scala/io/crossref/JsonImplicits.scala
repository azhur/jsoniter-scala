...
final class JsonCodecThings extends JsonValueCodec[io.crossref.ItemResponse] {
  ...
  private[this] val r2: Array[String] = Array("publisher", "reference-count", "references-count", "is-referenced-by-count", "source", "prefix", "DOI", "URL", "member", "type", "created", "deposited", "indexed", "issued", "score");
  ...
  private[this] def d2(in: JsonReader, default: scala.collection.immutable.Map[String, String]): scala.collection.immutable.Map[String, String] = if (in.isNextToken('{'))
    if (in.isNextToken('}'))
      default
    else {
      in.rollbackToken();
      ...
      do
        x = x.updated(in.readKeyAsString(), in.readString(null))
  ...
  private[this] def d5(in: JsonReader, default: Seq[String]): Seq[String] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d6(in: JsonReader, default: Option[String]): Option[String] = if (in.isNextToken('n'))
  ...
  private[this] def d9(in: JsonReader, default: Array[Int]): Array[Int] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d8(in: JsonReader, default: Array[Array[Int]]): Array[Array[Int]] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d7(in: JsonReader, default: io.crossref.DateParts): io.crossref.DateParts = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          case -560061439 => if (in.isCharBufEqualsTo(l, "date-parts")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
            ...
            in.skip()
          case -295034484 => if (in.isCharBufEqualsTo(l, "date-time")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 55126294 => if (in.isCharBufEqualsTo(l, "timestamp")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d10(in: JsonReader, default: io.crossref.PartialDate): io.crossref.PartialDate = if (in.isNextToken('{')) {
    var `_date-parts`: Array[Array[Int]] = v0;
    var p0 = 1;
    if (in.isNextToken('}').`unary_!`) {
      in.rollbackToken();
  ...
  private[this] def d11(in: JsonReader, default: Option[io.crossref.PartialDate]): Option[io.crossref.PartialDate] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(d10(in, null))
  ...
  private[this] def d13(in: JsonReader, default: io.crossref.ISSNType): io.crossref.ISSNType = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 111972721 => if (in.isCharBufEqualsTo(l, "value")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 3575610 => if (in.isCharBufEqualsTo(l, "type")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d12(in: JsonReader, default: Seq[io.crossref.ISSNType]): Seq[io.crossref.ISSNType] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d15(in: JsonReader, default: io.crossref.License): io.crossref.License = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case -467293308 => if (in.isCharBufEqualsTo(l, "content-version")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1548606901 => if (in.isCharBufEqualsTo(l, "delay-in-days")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 109757538 => if (in.isCharBufEqualsTo(l, "start")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 84303 => if (in.isCharBufEqualsTo(l, "URL")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d14(in: JsonReader, default: Seq[io.crossref.License]): Seq[io.crossref.License] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d17(in: JsonReader, default: io.crossref.Funder): io.crossref.Funder = if (in.isNextToken('{')) {
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          case 3373707 => if (in.isCharBufEqualsTo(l, "name")) {
            ...
            in.skip()
          case 67870 => if (in.isCharBufEqualsTo(l, "DOI")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 93223517 => if (in.isCharBufEqualsTo(l, "award")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1330102960 => if (in.isCharBufEqualsTo(l, "doi-asserted-by")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d16(in: JsonReader, default: Seq[io.crossref.Funder]): Seq[io.crossref.Funder] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d20(in: JsonReader, default: Option[Int]): Option[Int] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(in.readInt())
  ...
  private[this] def d22(in: JsonReader, default: io.crossref.AssertionGroup): io.crossref.AssertionGroup = if (in.isNextToken('{')) {
    var _name: String = null;
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          case 3373707 => if (in.isCharBufEqualsTo(l, "name")) {
            ...
            in.skip()
          case 102727412 => if (in.isCharBufEqualsTo(l, "label")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d21(in: JsonReader, default: Option[io.crossref.AssertionGroup]): Option[io.crossref.AssertionGroup] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(d22(in, null))
  ...
  private[this] def d19(in: JsonReader, default: io.crossref.Assertion): io.crossref.Assertion = if (in.isNextToken('{')) {
    var _name: String = null;
    var _value: String = null;
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          ...
          case 84303 => if (in.isCharBufEqualsTo(l, "URL")) {
            ...
            in.skip()
          case -1105867239 => if (in.isCharBufEqualsTo(l, "explanation")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
          ...
          case 102727412 => if (in.isCharBufEqualsTo(l, "label")) {
            ...
            in.skip()
          case 106006350 => if (in.isCharBufEqualsTo(l, "order")) {
            if (p0.&(32).!=(0))
              p0.^=(32)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 98629247 => if (in.isCharBufEqualsTo(l, "group")) {
            if (p0.&(64).!=(0))
              p0.^=(64)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(3).!=(0))
      ...
      ();
    new io.crossref.Assertion(name = _name, value = _value, URL = _URL, explanation = _explanation, label = _label, order = _order, group = _group)
  }
  else
    in.readNullOrTokenError(default, '{');

  private[this] def d18(in: JsonReader, default: Seq[io.crossref.Assertion]): Seq[io.crossref.Assertion] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d26(in: JsonReader, default: io.crossref.Affiliation): io.crossref.Affiliation = if (in.isNextToken('{')) {
    var _name: String = null;
    var p0 = 1;
    if (in.isNextToken('}').`unary_!`) {
      in.rollbackToken();
  ...
  private[this] def d25(in: JsonReader, default: Seq[io.crossref.Affiliation]): Seq[io.crossref.Affiliation] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d24(in: JsonReader, default: io.crossref.Authors): io.crossref.Authors = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 98367357 => if (in.isCharBufEqualsTo(l, "given")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1281860764 => if (in.isCharBufEqualsTo(l, "family")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 2019918576 => if (in.isCharBufEqualsTo(l, "affiliation")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d23(in: JsonReader, default: Seq[io.crossref.Authors]): Seq[io.crossref.Authors] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d29(in: JsonReader, default: Option[Boolean]): Option[Boolean] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(in.readBoolean())
  ...
  private[this] def d28(in: JsonReader, default: io.crossref.Contributor): io.crossref.Contributor = if (in.isNextToken('{')) {
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          ...
          case 98367357 => if (in.isCharBufEqualsTo(l, "given")) {
            ...
            in.skip()
          case 75467739 => if (in.isCharBufEqualsTo(l, "ORCID")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -55038755 => if (in.isCharBufEqualsTo(l, "authenticated-orcid")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(1).!=(0))
      ...
      ();
    new io.crossref.Contributor(family = _family, given = _given, ORCID = _ORCID, `authenticated-orcid` = `_authenticated-orcid`, affiliation = _affiliation)
  }
  else
    in.readNullOrTokenError(default, '{');

  private[this] def d27(in: JsonReader, default: Seq[io.crossref.Contributor]): Seq[io.crossref.Contributor] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d31(in: JsonReader, default: io.crossref.Update): io.crossref.Update = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case -234430277 => if (in.isCharBufEqualsTo(l, "updated")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d30(in: JsonReader, default: Seq[io.crossref.Update]): Seq[io.crossref.Update] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d33(in: JsonReader, default: io.crossref.Link): io.crossref.Link = if (in.isNextToken('{')) {
    var _URL: String = null;
      ...
      do {
        ...
        (in.charBufToHashCode(l): @switch) match {
          case 84303 => if (in.isCharBufEqualsTo(l, "URL")) {
            ...
            in.skip()
          case 785670158 => if (in.isCharBufEqualsTo(l, "content-type")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
          ...
          case -467293308 => if (in.isCharBufEqualsTo(l, "content-version")) {
            ...
            in.skip()
          case 1252392622 => if (in.isCharBufEqualsTo(l, "intended-application")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(15).!=(0))
      ...
      ();
    new io.crossref.Link(URL = _URL, `content-type` = `_content-type`, `content-version` = `_content-version`, `intended-application` = `_intended-application`)
  }
  else
    in.readNullOrTokenError(default, '{');

  private[this] def d32(in: JsonReader, default: Seq[io.crossref.Link]): Seq[io.crossref.Link] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d35(in: JsonReader, default: io.crossref.ClinicalTrialNumber): io.crossref.ClinicalTrialNumber = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 151266906 => if (in.isCharBufEqualsTo(l, "clinical-trial-number")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -690212803 => if (in.isCharBufEqualsTo(l, "registry")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d34(in: JsonReader, default: Seq[io.crossref.ClinicalTrialNumber]): Seq[io.crossref.ClinicalTrialNumber] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d39(in: JsonReader, default: io.crossref.JournalIssue): io.crossref.JournalIssue = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 100509913 => if (in.isCharBufEqualsTo(l, "issue")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d38(in: JsonReader, default: Option[io.crossref.JournalIssue]): Option[io.crossref.JournalIssue] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(d39(in, null))
  ...
  private[this] def d37(in: JsonReader, default: io.crossref.Reference): io.crossref.Reference = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 106079 => if (in.isCharBufEqualsTo(l, "key")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1406328437 => if (in.isCharBufEqualsTo(l, "author")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
          ...
          case 100509913 => if (in.isCharBufEqualsTo(l, "issue")) {
            ...
            in.skip()
          case -1887963714 => if (in.isCharBufEqualsTo(l, "edition")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1399907075 => if (in.isCharBufEqualsTo(l, "component")) {
            if (p0.&(16).!=(0))
              p0.^=(16)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 61026596 => if (in.isCharBufEqualsTo(l, "standard-designator")) {
            if (p0.&(32).!=(0))
              p0.^=(32)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1135736903 => if (in.isCharBufEqualsTo(l, "standards-body")) {
            if (p0.&(64).!=(0))
              p0.^=(64)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1988238166 => if (in.isCharBufEqualsTo(l, "unstructured")) {
            if (p0.&(128).!=(0))
              p0.^=(128)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -768937279 => if (in.isCharBufEqualsTo(l, "article-title")) {
            if (p0.&(256).!=(0))
              p0.^=(256)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -563134590 => if (in.isCharBufEqualsTo(l, "series-title")) {
            if (p0.&(512).!=(0))
              p0.^=(512)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1516364261 => if (in.isCharBufEqualsTo(l, "volume-title")) {
            if (p0.&(1024).!=(0))
              p0.^=(1024)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1557928253 => if (in.isCharBufEqualsTo(l, "journal-issue")) {
            if (p0.&(2048).!=(0))
              p0.^=(2048)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 2257157 => if (in.isCharBufEqualsTo(l, "ISSN")) {
            if (p0.&(4096).!=(0))
              p0.^=(4096)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -66383102 => if (in.isCharBufEqualsTo(l, "issn-type")) {
            if (p0.&(8192).!=(0))
              p0.^=(8192)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 2256630 => if (in.isCharBufEqualsTo(l, "ISBN")) {
            if (p0.&(16384).!=(0))
              p0.^=(16384)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 2025923505 => if (in.isCharBufEqualsTo(l, "isbn-type")) {
            if (p0.&(32768).!=(0))
              p0.^=(32768)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -810883302 => if (in.isCharBufEqualsTo(l, "volume")) {
            if (p0.&(65536).!=(0))
              p0.^=(65536)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -207102068 => if (in.isCharBufEqualsTo(l, "first-page")) {
            if (p0.&(131072).!=(0))
              p0.^=(131072)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 3704893 => if (in.isCharBufEqualsTo(l, "year")) {
            if (p0.&(262144).!=(0))
              p0.^=(262144)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1548066750 => if (in.isCharBufEqualsTo(l, "journal-title")) {
            if (p0.&(524288).!=(0))
              p0.^=(524288)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(1).!=(0))
      ...
      ();
    new io.crossref.Reference(key = _key, author = _author, issue = _issue, edition = _edition, component = _component, `standard-designator` = `_standard-designator`, `standards-body` = `_standards-body`, unstructured = _unstructured, `article-title` = `_article-title`, `series-title` = `_series-title`, `volume-title` = `_volume-title`, `journal-issue` = `_journal-issue`, ISSN = _ISSN, `issn-type` = `_issn-type`, ISBN = _ISBN, `isbn-type` = `_isbn-type`, volume = _volume, `first-page` = `_first-page`, year = _year, `journal-title` = `_journal-title`, DOI = _DOI, `doi-asserted-by` = `_doi-asserted-by`)
  }
  else
    in.readNullOrTokenError(default, '{');

  private[this] def d36(in: JsonReader, default: Seq[io.crossref.Reference]): Seq[io.crossref.Reference] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d41(in: JsonReader, default: io.crossref.ContentDomain): io.crossref.ContentDomain = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case -1326197564 => if (in.isCharBufEqualsTo(l, "domain")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 367294732 => if (in.isCharBufEqualsTo(l, "crossmark-restriction")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d40(in: JsonReader, default: Option[io.crossref.ContentDomain]): Option[io.crossref.ContentDomain] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
    Some(d41(in, null))
  ...
  private[this] def d44(in: JsonReader, default: io.crossref.Relation): io.crossref.Relation = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 1606655148 => if (in.isCharBufEqualsTo(l, "id-type")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
          ...
          case 3355 => if (in.isCharBufEqualsTo(l, "id")) {
            ...
            in.skip()
          case 409999551 => if (in.isCharBufEqualsTo(l, "asserted-by")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d43(in: JsonReader, default: scala.collection.immutable.Map[String, io.crossref.Relation]): scala.collection.immutable.Map[String, io.crossref.Relation] = if (in.isNextToken('{'))
    if (in.isNextToken('}'))
      default
    else {
      in.rollbackToken();
      ...
      do
        x = x.updated(in.readKeyAsString(), d44(in, null))
      while (in.isNextToken(','));
      if (in.isCurrentToken('}'))
        x
      else
  ...
  private[this] def d42(in: JsonReader, default: Option[Map[String, io.crossref.Relation]]): Option[Map[String, io.crossref.Relation]] = if (in.isNextToken('n'))
    in.readNullOrError(default, "expected value or null")
  else {
    in.rollbackToken();
  ...
  private[this] def d4(in: JsonReader, default: io.crossref.Publication): io.crossref.Publication = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 1447404028 => if (in.isCharBufEqualsTo(l, "publisher")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 110371416 => if (in.isCharBufEqualsTo(l, "title")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 498884444 => if (in.isCharBufEqualsTo(l, "original-title")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -130716217 => if (in.isCharBufEqualsTo(l, "short-title")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1732898850 => if (in.isCharBufEqualsTo(l, "abstract")) {
            if (p0.&(16).!=(0))
              p0.^=(16)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -216743923 => if (in.isCharBufEqualsTo(l, "reference-count")) {
            if (p0.&(32).!=(0))
              p0.^=(32)
            else
              in.duplicatedKeyError(l);
            _referenceCount = in.readInt()
          }
          else
            in.skip()
          case -1985607286 => if (in.isCharBufEqualsTo(l, "references-count")) {
            if (p0.&(64).!=(0))
              p0.^=(64)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1152800822 => if (in.isCharBufEqualsTo(l, "is-referenced-by-count")) {
            if (p0.&(128).!=(0))
              p0.^=(128)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -896505829 => if (in.isCharBufEqualsTo(l, "source")) {
            if (p0.&(256).!=(0))
              p0.^=(256)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -980110702 => if (in.isCharBufEqualsTo(l, "prefix")) {
            if (p0.&(512).!=(0))
              p0.^=(512)
            else
              in.duplicatedKeyError(l);
          ...
          case 84303 => if (in.isCharBufEqualsTo(l, "URL")) {
            ...
            in.skip()
          case -1077769574 => if (in.isCharBufEqualsTo(l, "member")) {
            if (p0.&(4096).!=(0))
              p0.^=(4096)
            else
              in.duplicatedKeyError(l);
          ...
          case 3575610 => if (in.isCharBufEqualsTo(l, "type")) {
            ...
            in.skip()
          case 1028554472 => if (in.isCharBufEqualsTo(l, "created")) {
            if (p0.&(16384).!=(0))
              p0.^=(16384)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -818154563 => if (in.isCharBufEqualsTo(l, "deposited")) {
            if (p0.&(32768).!=(0))
              p0.^=(32768)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1943292145 => if (in.isCharBufEqualsTo(l, "indexed")) {
            if (p0.&(65536).!=(0))
              p0.^=(65536)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1179159893 => if (in.isCharBufEqualsTo(l, "issued")) {
            if (p0.&(131072).!=(0))
              p0.^=(131072)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -982450881 => if (in.isCharBufEqualsTo(l, "posted")) {
            if (p0.&(262144).!=(0))
              p0.^=(262144)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -2146525273 => if (in.isCharBufEqualsTo(l, "accepted")) {
            if (p0.&(524288).!=(0))
              p0.^=(524288)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -2060497896 => if (in.isCharBufEqualsTo(l, "subtitle")) {
            if (p0.&(1048576).!=(0))
              p0.^=(1048576)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -675652084 => if (in.isCharBufEqualsTo(l, "container-title")) {
            if (p0.&(2097152).!=(0))
              p0.^=(2097152)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -2086442309 => if (in.isCharBufEqualsTo(l, "short-container-title")) {
            if (p0.&(4194304).!=(0))
              p0.^=(4194304)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -328855158 => if (in.isCharBufEqualsTo(l, "group-title")) {
            if (p0.&(8388608).!=(0))
              p0.^=(8388608)
            else
              in.duplicatedKeyError(l);
          ...
          case -810883302 => if (in.isCharBufEqualsTo(l, "volume")) {
            ...
            in.skip()
          case 3433103 => if (in.isCharBufEqualsTo(l, "page")) {
            if (p0.&(67108864).!=(0))
              p0.^=(67108864)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1771837440 => if (in.isCharBufEqualsTo(l, "article-number")) {
            if (p0.&(134217728).!=(0))
              p0.^=(134217728)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 452836878 => if (in.isCharBufEqualsTo(l, "published-print")) {
            if (p0.&(268435456).!=(0))
              p0.^=(268435456)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1120802578 => if (in.isCharBufEqualsTo(l, "published-online")) {
            if (p0.&(536870912).!=(0))
              p0.^=(536870912)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1867885268 => if (in.isCharBufEqualsTo(l, "subject")) {
            if (p0.&(1073741824).!=(0))
              p0.^=(1073741824)
            else
              in.duplicatedKeyError(l);
          ...
          case 2256630 => if (in.isCharBufEqualsTo(l, "ISBN")) {
            ...
            in.skip()
          case -748101438 => if (in.isCharBufEqualsTo(l, "archive")) {
            if (p1.&(4).!=(0))
              p1.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 166757441 => if (in.isCharBufEqualsTo(l, "license")) {
            if (p1.&(8).!=(0))
              p1.^=(8)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1263365582 => if (in.isCharBufEqualsTo(l, "funder")) {
            if (p1.&(16).!=(0))
              p1.^=(16)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1314395906 => if (in.isCharBufEqualsTo(l, "assertion")) {
            if (p1.&(32).!=(0))
              p1.^=(32)
            else
              in.duplicatedKeyError(l);
          ...
          case -1406328437 => if (in.isCharBufEqualsTo(l, "author")) {
            ...
            in.skip()
          case -1307827859 => if (in.isCharBufEqualsTo(l, "editor")) {
            if (p1.&(128).!=(0))
              p1.^=(128)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 94623429 => if (in.isCharBufEqualsTo(l, "chair")) {
            if (p1.&(256).!=(0))
              p1.^=(256)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1721943526 => if (in.isCharBufEqualsTo(l, "translator")) {
            if (p1.&(512).!=(0))
              p1.^=(512)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1949245953 => if (in.isCharBufEqualsTo(l, "update-to")) {
            if (p1.&(1024).!=(0))
              p1.^=(1024)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 1434653366 => if (in.isCharBufEqualsTo(l, "update-policy")) {
            if (p1.&(2048).!=(0))
              p1.^=(2048)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 3321850 => if (in.isCharBufEqualsTo(l, "link")) {
            if (p1.&(4096).!=(0))
              p1.^=(4096)
            else
              in.duplicatedKeyError(l);
          ...
          case 151266906 => if (in.isCharBufEqualsTo(l, "clinical-trial-number")) {
            ...
            in.skip()
          case -73084101 => if (in.isCharBufEqualsTo(l, "alternative-id")) {
            if (p1.&(16384).!=(0))
              p1.^=(16384)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -925155509 => if (in.isCharBufEqualsTo(l, "reference")) {
            if (p1.&(32768).!=(0))
              p1.^=(32768)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1352613736 => if (in.isCharBufEqualsTo(l, "content-domain")) {
            if (p1.&(65536).!=(0))
              p1.^=(65536)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -554436100 => if (in.isCharBufEqualsTo(l, "relation")) {
            if (p1.&(131072).!=(0))
              p1.^=(131072)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 109264530 => if (in.isCharBufEqualsTo(l, "score")) {
            if (p1.&(262144).!=(0))
              p1.^=(262144)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d3(in: JsonReader, default: Seq[io.crossref.Publication]): Seq[io.crossref.Publication] = if (in.isNextToken('['))
    if (in.isNextToken(']'))
      default
    else {
      in.rollbackToken();
  ...
  private[this] def d45(in: JsonReader, default: io.crossref.Query): io.crossref.Query = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case 1330622375 => if (in.isCharBufEqualsTo(l, "start-index")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -967973598 => if (in.isCharBufEqualsTo(l, "search-terms")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
  ...
  private[this] def d1(in: JsonReader, default: io.crossref.Items): io.crossref.Items = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case -1282162276 => if (in.isCharBufEqualsTo(l, "facets")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -2118551955 => if (in.isCharBufEqualsTo(l, "total-results")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 100526016 => if (in.isCharBufEqualsTo(l, "items")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 157438124 => if (in.isCharBufEqualsTo(l, "items-per-page")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 107944136 => if (in.isCharBufEqualsTo(l, "query")) {
            if (p0.&(16).!=(0))
              p0.^=(16)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -378975376 => if (in.isCharBufEqualsTo(l, "next-cursor")) {
            if (p0.&(32).!=(0))
              p0.^=(32)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(26).!=(0))
      ...
      ();
    new io.crossref.Items(facets = _facets, `total-results` = `_total-results`, items = _items, `items-per-page` = `_items-per-page`, query = _query, `next-cursor` = `_next-cursor`)
  }
  else
    in.readNullOrTokenError(default, '{');

  private[this] def d0(in: JsonReader, default: io.crossref.ItemResponse): io.crossref.ItemResponse = if (in.isNextToken('{')) {
    ...
    if (in.isNextToken('}').`unary_!`) {
      ...
      do {
        val l = in.readKeyAsCharBuf();
        (in.charBufToHashCode(l): @switch) match {
          case -892481550 => if (in.isCharBufEqualsTo(l, "status")) {
            if (p0.&(1).!=(0))
              p0.^=(1)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -1332241088 => if (in.isCharBufEqualsTo(l, "message-type")) {
            if (p0.&(2).!=(0))
              p0.^=(2)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case -2091644654 => if (in.isCharBufEqualsTo(l, "message-version")) {
            if (p0.&(4).!=(0))
              p0.^=(4)
            else
              in.duplicatedKeyError(l);
            ...
            in.skip()
          case 954925063 => if (in.isCharBufEqualsTo(l, "message")) {
            if (p0.&(8).!=(0))
              p0.^=(8)
            else
              in.duplicatedKeyError(l);
    ...
    if (p0.&(15).!=(0))
      ...
      ();
    new io.crossref.ItemResponse(status = _status, `message-type` = `_message-type`, `message-version` = `_message-version`, message = _message)
  }
  else
    in.readNullOrTokenError(default, '{');
